...
newtype ShutdownParams = ShutdownParams
    { shutdownHow :: CInt
    }
    deriving stock (Eq, Show, Generic)

newtype PollAddParams = PollAddParams
    { pollMask :: Word32
    }
    deriving stock (Eq, Show, Generic)

newtype TimeoutParams = TimeoutParams
    { timeoutNanoseconds :: Word64
    }
    deriving stock (Eq, Show, Generic)

newtype CancelParams = CancelParams
    { cancelTarget :: Handle
    }
    deriving stock (Eq, Show, Generic)

newtype UnlinkParams = UnlinkParams
...
makeOpen path flags mode userData =
    Operation
        { opHandle = invalidHandle
        , opType = Open
        , opUserData = userData
...
makeOpenat dirFd path flags mode userData =
    Operation
        { opHandle = invalidHandle
        , opType = Openat
        , opUserData = userData
...
makeRead h buf len offset userData =
    Operation
        { opHandle = h
        , opType = Read
        , opUserData = userData
...
makeWrite h buf len offset userData =
    Operation
        { opHandle = h
        , opType = Write
        , opUserData = userData
...
makeStatx dirFd path flags mask buf userData =
    Operation
        { opHandle = invalidHandle
        , opType = Statx
        , opUserData = userData
...
makeMkdirat dirFd path mode userData =
    Operation
        { opHandle = invalidHandle
        , opType = Mkdirat
        , opUserData = userData
...
makeUnlinkat dirFd path flags userData =
    Operation
        { opHandle = invalidHandle
        , opType = Unlinkat
        , opUserData = userData
...
makeRename oldPath newPath userData =
    Operation
        { opHandle = invalidHandle
        , opType = Rename
        , opUserData = userData
...
makeRenameat oldDirFd oldPath newDirFd newPath flags userData =
    Operation
        { opHandle = invalidHandle
        , opType = Renameat
        , opUserData = userData
...
makeSymlink target linkpath userData =
    Operation
        { opHandle = invalidHandle
        , opType = Symlink
        , opUserData = userData
...
makeSymlinkat target dirFd linkpath userData =
    Operation
        { opHandle = invalidHandle
        , opType = Symlinkat
        , opUserData = userData
...
makeLink oldPath newPath userData =
    Operation
        { opHandle = invalidHandle
        , opType = Link
        , opUserData = userData
...
makeLinkat oldDirFd oldPath newDirFd newPath flags userData =
    Operation
        { opHandle = invalidHandle
        , opType = Linkat
        , opUserData = userData
...
makeSocket domain typ protocol flags userData =
    Operation
        { opHandle = invalidHandle
        , opType = Socket
        , opUserData = userData
...
makeConnect h addr addrLen userData =
    Operation
        { opHandle = h
        , opType = Connect
        , opUserData = userData
...
makeAccept h addr addrLen flags userData =
    Operation
        { opHandle = h
        , opType = Accept
        , opUserData = userData
...
makeSend h buf len flags userData =
    Operation
        { opHandle = h
        , opType = Send
        , opUserData = userData
...
makeRecv h buf len flags userData =
    Operation
        { opHandle = h
        , opType = Recv
        , opUserData = userData
